...
void Lab2::Update(float deltaTimeSeconds) {
    ...
    RenderMesh(meshes["cube_A"], shaders["VertexColor"],
               glm::vec3(-1.5f, 0.5f, 0), glm::vec3(0.25f));

    RenderMesh(meshes["cube_B"], shaders["VertexColor"],
               glm::vec3(0, 0.5f, -1.5f), glm::vec3(0.75f));

    RenderMesh(meshes["tetrahedron"], shaders["VertexNormal"],
               glm::vec3(1.5f, -0.5f, 0), glm::vec3(0.25f));

    RenderMesh(meshes["square"], shaders["VertexNormal"],
               glm::vec3(2.5f, -0.5f, 0), glm::vec3(0.75f));
